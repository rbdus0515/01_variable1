...
public static void main(String[] args) {
		...
		// -> 컴퓨터는 숫자를 2진수로 표현한다.
		// -> 3.333333.. 이런 실수도 11.010110111011.. 이런식으로 2진수로 표현하면 무한히 반복되는 경우가 많다.
		// 따라서 일정한 크기만큼 계산하고 적당한 위치에서 잘라내어 반올림하는데
		// 2진수 -> 10진수로 변환했을 때
		// float 7~8자리까지 자르고, double은 15~16자리까지 자름.
		// 자르는 위치가 다르니까 숫자가 다르게 나올 수 있다.
		// -> 2진수로 소수점 이하를 정확하게 표현하지 못하는 경우가 많아서 근사치가 출력되게 된다. 2진수 -> 10진수 변환이 잘못 된 경우.
		System.out.println();
